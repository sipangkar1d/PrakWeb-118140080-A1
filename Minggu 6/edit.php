<?php
	...
	if(empty($nim))
	{
		?><div class="text-center">Tidak ada record yang ditemukan <a href="#" onclick="$('#link-add').hide();$('#show-add').show(700);">Hide this</a></div>
		<?php
		die();
	}
	...
	while($row = mysqli_fetch_assoc($result))
	{
		...
		<div class="form-inline" id="edit-data">
			...
			<div class="form-group col-md-3">
			<button type="button" class="btn btn-primary update" id="<?php echo $row['nim']; ?>" name="update">Update Record</button>
